      ...
      <section className="bg-gradient-to-br from-slate-50 to-blue-50 py-16 border-b border-blue-100">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a href="https://wa.me/201062485133" className="bg-[#107060] text-white px-7 py-3 rounded-xl font-bold hover:bg-[#084941] transition-colors shadow">اطلب موقعك الآن</a>
      ...
      <main className="container mx-auto px-6 py-14 max-w-4xl">
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <Link href="/services/website" className="p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] hover:shadow transition-all text-slate-700 font-medium text-sm">🌐 تفاصيل خدمة تصميم المواقع</Link>
          </div>
        </section>
