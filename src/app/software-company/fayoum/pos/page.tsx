    ...
    <div dir="rtl" lang="ar" className="min-h-screen bg-white font-sans">
      ...
      <header className="bg-gradient-to-l from-[#084941] to-[#2DBEA1] text-white py-4 shadow-lg">
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <a href="https://wa.me/201062485133" className="bg-white text-[#107060] px-4 py-2 rounded-lg font-semibold text-sm hover:bg-gray-100 transition-colors">احصل على ديمو</a>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-br from-slate-50 to-blue-50 py-16 border-b border-blue-100">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a href="https://wa.me/201062485133" className="bg-[#107060] text-white px-7 py-3 rounded-xl font-bold hover:bg-[#084941] transition-colors shadow">احصل على ديمو مجاني</a>
      ...
      <main className="container mx-auto px-6 py-14 max-w-4xl">
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <Link href="/software-company/fayoum/online-store" className="p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] hover:shadow transition-all text-slate-700 font-medium text-sm">🛒 متجر إلكتروني في الفيوم</Link>
            ...
            <Link href="/services/pos" className="p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] hover:shadow transition-all text-slate-700 font-medium text-sm">🏪 تفاصيل خدمة أنظمة POS</Link>
          </div>
        </section>
