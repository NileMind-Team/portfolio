...
const solutions = [
  ...
  { emoji: '🌐', title: 'موقع متعدد اللغات', slug: 'website', desc: 'روابط منفصلة لكل لغة (فرنسي، روسي، ألماني، إنجليزي، إيطالي) تظهر في بحث بلد الزائر — لا مجرد زر ترجمة آلي لا يُفهرَس.' },
...
const faqs = [
  ...
  { q: 'بكم لغة يمكن بناء الموقع؟', a: 'نبني الموقع بأي عدد من اللغات (فرنسي، روسي، ألماني، إنجليزي، إيطالي…) بروابط منفصلة لكل لغة لتظهر في بحث بلد الزائر، لا مجرد ترجمة آلية. والفرنسية والروسية والألمانية تحديداً هي الأعلى بحثاً عن وجهات مصر السياحية.' },
      ...
      <section className="bg-gradient-to-l from-[#084941] to-[#107060] text-white">
        <nav className="container mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="flex gap-6 text-sm">
            ...
            <Link href="/gulf-software" className="hover:text-blue-200 transition-colors">حلول الخليج</Link>
