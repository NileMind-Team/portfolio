      ...
      <section className="bg-gradient-to-br from-slate-50 to-blue-50 py-16 border-b border-blue-100">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a href="https://wa.me/201062485133" className="bg-[#107060] text-white px-7 py-3 rounded-xl font-bold hover:bg-[#084941] transition-colors shadow">احصل على استشارة مجانية</a>
      ...
      <main className="container mx-auto px-6 py-14 max-w-5xl">
        ...
        <section className="mb-14">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/services/custom-system" className="p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] hover:shadow transition-all text-slate-700 font-medium text-sm">🔧 الأنظمة البرمجية المخصصة</Link>
            <Link href="/services/pos" className="p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] hover:shadow transition-all text-slate-700 font-medium text-sm">🏪 نظام نقاط البيع POS</Link>
            <Link href="/services/store" className="p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] hover:shadow transition-all text-slate-700 font-medium text-sm">🛒 متجر إلكتروني مع إدارة مخزون</Link>
