...
const services = [
  ...
  },
  {
    ...
    descAr:
      'متاجر إلكترونية متكاملة: بوابات دفع، إدارة مخزون، لوحة تحكم — جاهزة للمبيعات الفورية.',
    icon: '🛒',
  },
  {
    slug: 'pos',
  ...
  },
  {
    ...
    nameAr: 'تصميم UI/UX',
    descAr:
      'تصميم واجهات مستخدم احترافية على Figma. تجربة مستخدم محكمة تزيد معدلات التحويل.',
    icon: '🎨',
  },
  {
    slug: 'devops',
    ...
    descAr:
      'نشر Docker على VPS، CI/CD، مراقبة الأداء، وضمان وقت تشغيل ٩٩.٩٪.',
    icon: '⚙️',
  },
  {
    slug: 'erp',
    nameAr: 'أنظمة ERP وإدارة الأعمال',
    descAr:
      'حلول ERP مخصصة تدير مخازنك، فواتيرك، وموظفيك من لوحة تحكم واحدة.',
    icon: '📊',
  },
  {
    slug: 'api',
    nameAr: 'تطوير API والتكاملات',
    descAr:
      'بناء وتوثيق APIs RESTful وGraphQL، وتكامل مع بوابات الدفع وخدمات الطرف الثالث.',
    icon: '🔗',
  },
]
