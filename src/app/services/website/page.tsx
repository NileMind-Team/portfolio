      ...
      <main className="container mx-auto px-6 py-14 max-w-5xl">
        ...
        <section className="mb-14">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {techStack.map((tech) => (
              <div key={tech.name} className="flex items-start gap-3 p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] transition-colors">
        ...
        <section className="mb-14">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/services/store" className="p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] hover:shadow transition-all text-slate-700 font-medium text-sm">🛒 إنشاء المتاجر الإلكترونية</Link>
            ...
            <Link href="/services/support" className="p-4 bg-white border border-slate-200 rounded-xl hover:border-[#2DBEA1] hover:shadow transition-all text-slate-700 font-medium text-sm">🛡️ الدعم الفني والصيانة</Link>
