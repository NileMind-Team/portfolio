...
const faqs = [
  ...
  { q: 'هل لديكم خبرة فعلية مع المطاعم؟', a: 'نعم، نفّذنا منصة «فطير وعسل» بنظام طلب أونلاين وإدارة توصيل وقائمة، وموقع «تشيكن ون» لمجموعة الزعوي — نماذج فعلية لما نبنيه لأي مطعم أو كافيه.' },
]
