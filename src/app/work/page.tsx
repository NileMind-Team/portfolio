...
export const metadata: Metadata = {
  ...
  description:
    'دراسات حالة لمشاريع حقيقية نفّذتها DoGether: مواقع، متاجر إلكترونية، أنظمة كاشير، ومنصات حجز لعملاء في مصر. تشيكن ون، الزاوي، فطير وعسل، شرم كايت سيرف وغيرها.',
...
const projects: Project[] = [
  {
    name: 'Chicken One — الزاوي',
    client: 'مجموعة الزاوي',
    category: 'موقع شركة',
    description:
      'موقع شركة عصري لعلامة Chicken One التابعة لمجموعة الزاوي، بتصميم متجاوب وتجربة مستخدم سلسة تعرّف بالعلامة ومنتجاتها.',
  ...
  },
  {
    ...
    description:
      'منصة تجارة إلكترونية متكاملة لمجموعة الزاوي مع إدارة المنتجات وسلة التسوق والدفع الآمن.',
